...
ui <- fluidPage(
  ...
  sidebarLayout( 
    sidebarPanel(
      fluidRow(selectInput("barcodes", "Where are your barcodes located?", choices = list("In Illumina Headers",
                                                                                          "Start of Reads",
                                                                                          "Seperate fastq File"),
                           multiple = TRUE),
               checkboxInput("paired_or_single", "Is your data paired-end?", value = FALSE),
               actionButton("visualize_barcodes", "Click for example of selection"))
    ),
    mainPanel(
...
server <- function(input, output, session) {
  ...
  barcode.type <- eventReactive(input$visualize_barcodes,{
    img_table <- data.frame(input = c("In Illumina Headers",
                                      "Start of Reads",
                                      "Seperate fastq File"),
